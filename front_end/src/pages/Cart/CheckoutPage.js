                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            {selectedAddress?._id === address._id && (
                              <span className="bg-blue-600 text-white text-xs px-2 py-1 rounded">Đã chọn</span>
                            )}
                          </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">Thanh toán trực tuyến (VNPay)</div>
                        <div className="text-sm text-gray-600">Thanh toán qua thẻ ATM, thẻ quốc tế, ví điện tử</div>
                      </div>
                    </div>
                    {selectedPaymentMethod === 'VNPAY' && (
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                {displayCart.items.map((item) => (
                  <div key={item._id || `${item.productId}-${item.variantId}`} className="flex gap-4 pb-4 border-b last:border-0">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-4">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition font-semibold text-lg flex items-center justify-center gap-2"
              >
                {creating ? (
                  <>
                  ...
                  <>
                    ...
                    {selectedPaymentMethod === 'VNPAY' ? 'Thanh toán VNPay' : 'Đặt hàng (COD)'}
                  </>
                )}
              </button>
